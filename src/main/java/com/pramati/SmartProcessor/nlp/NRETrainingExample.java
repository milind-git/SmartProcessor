package com.pramati.SmartProcessor.nlp;
 ...
 */
public class NRETrainingExample {
 
    public static void main(String[] args) throws Exception {
 
        // reading training data
        InputStreamFactory in = null;
        String filename="actionmodel.txt";
        try {
            in = new MarkableFileInputStreamFactory(new File(NRETrainingExample.class.getClassLoader().getSystemResource(filename).toURI()));
        ...
        String[] testSentence ={"I","want","to","apply","for","leave","next","tuesday"};
        //String[] testSentence ={"Show", "Holiday","calendar", "for", "2017"};
        //String[] testSentence ={"Alisa","cnet","is","a","tourist","from","India"};
